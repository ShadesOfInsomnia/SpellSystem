...
namespace Shadex
{
    ...
    public class ReOrganiseHelper : EditorWindow
    {
        ...
        string[] sCharacterPaths = { "Invector-3rdPersonController/Add-ons/ReOrganise/Prefabs/Characters/Clean", "Invector-3rdPersonController/Add-ons/ReOrganise/Prefabs/Creatures/Clean" };
        int iCurrentCreator = 0;
        string[] sCreatorPrefix = { "All", };
